...
import {normalizeHighlightLines} from './highlights';
...
export function CodeEditor({p,runtime,nodeId}:FeatureProps){
 ...
 useEffect(()=>{highlight.current?.(!!p.revealHighlightedLine);},[p.highlightLines,p.revealHighlightedLine]);
